...
## input - common
_model_ = 'L691A_part3'
_mydata_ = '/home/nai/CNN_SJ/data_file/L691A_part.bin'
...
X_train, X_valid = mydata["X_train3"], mydata["X_valid3"]
Y_train, Y_valid = mydata["Y_train3"], mydata["Y_valid3"]
...
## test
X_test = mydata["X_test3"]
Y_test = mydata["Y_test3"]
X_test  -= mean_train
