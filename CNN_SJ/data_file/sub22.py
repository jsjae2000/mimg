...
out_data = "sub0405_U1.bin" # data file
nb_classes = 2
norm_tp = "SDSP1"
rate_train = 0.6
...
out_feat = "sub0405_feature_U1.bin"
...
X_train = np.zeros( (img_train.shape[0]*2, img_rows, img_cols, 3) )
X_valid = np.zeros( (img_valid.shape[0]*2, img_rows, img_cols, 3) )
X_test  = np.zeros( (img_test.shape[0]*2,  img_rows, img_cols, 3) )
...
############################## 691
path_image = "/home/nai/CNN_SJ/sL691A_0405data/" # location of original images
resize_folder = "/home/nai/sL691A_0405_144/"
folder_image = os.listdir(path_image)
