...
GPU run command:
    THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32 python sL691A_feature.py
'''
...
np.savetxt('L691A_train.csv', feat_train, delimiter=",")
np.savetxt('L691A_test.csv', feat_test, delimiter=",")
np.savetxt('L691Ach_train.csv', char_train, delimiter=",", fmt="%s")
np.savetxt('L691Ach_test.csv', char_test, delimiter=",", fmt="%s")
