...
for image_type in folder_image:
    ...
    for image in os.listdir(path_image + "/" + image_type):
        ...
        if image_name in img_train[:,1]:
            ...
            img2 = Image.open("/home/nai/CNN_SJ/L290A_defect0405/" + image_type + "/" + image)
            img2 = img2.resize( (img_cols, img_rows), Image.ANTIALIAS )
            img2.save( "/home/nai/L290A_defect0405_144/" + image )
            img2 = Image.open( "/home/nai/L290A_defect0405_144/" + image )
