...
path_image = "/home/nai/sL691A" # location of original images
resize_folder = "/home/nai/sL691A_" + str(img_size) + "/"
char_train_name = "/home/nai/CNN_SJ/data_file/L691Ach_train.csv"
char_test_name  = "/home/nai/CNN_SJ/data_file/L691Ach_test.csv"
...
#### input - feature
feat_tr_valid_name = '/home/nai/CNN_SJ/data_file/L691A_train.csv'
feat_test_name = '/home/nai/CNN_SJ/data_file/L691A_test.csv'
...
X_train3, Y_train3 = X_train[ np.where(aoi_train==3)[0], : ,: ,:], Y_train[ np.where(aoi_train==3)[0], :]
X_valid3, Y_valid3 = X_valid[ np.where(aoi_valid==3)[0], : ,: ,:], Y_valid[ np.where(aoi_valid==3)[0], :]
X_test3, Y_test3   = X_test[  np.where(aoi_test==3)[0], : ,: , :], Y_test[  np.where(aoi_test==3)[0],  :]
...
print 'X_train3 X_valid3 X_test3', X_train3.shape, X_valid3.shape, X_test3.shape
...
np.savez(outdata, X_train3 = X_train3, Y_train3 = Y_train3,
         X_valid3 = X_valid3, Y_valid3 = Y_valid3,
...
feat_train3 = feat_train[ np.where(aoi_train==3)[0], :]
feat_valid3 = feat_valid[ np.where(aoi_valid==3)[0], :]
feat_test3  = feat_test[  np.where(aoi_test==3)[0],  :]
...
np.savez(outdata, feat_train3 = feat_train3, feat_valid3 = feat_valid3, feat_test3 = feat_test3,
